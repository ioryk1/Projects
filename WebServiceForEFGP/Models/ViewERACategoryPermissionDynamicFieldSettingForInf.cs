...
namespace WebServiceForEFGP.Models
{
    ...
    public partial class ViewERACategoryPermissionDynamicFieldSettingForInf
    {
        ...
        public string DFS_name_type { get; set; }
        public string CDF_ID_T { get; set; }
        public string CDF_ID_B { get; set; }
